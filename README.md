...
- Engineering/Hardware: Arduino, Ultrasonic Sensors, DIY Circuit Design.


## Featured Projects

1. Smart Security System (Arduino)

Description: A robust security system utilizing ultrasonic sensors for intruder detection and automated alerts.
...
Description: An automated gate system designed for smart parking or gated communities, triggered by sensor proximity and controlled via servomotors.




# What I'm working on right now
- Refining my profile for Mechanical Engineering (Fall 2027).

- Building more complex mechatronics projects.
